...
exports.Product = exports.SaleType = void 0;
...
], Product.prototype, "price_perKg", void 0);
__decorate([
    (0, typeorm_1.Column)({
        name: "price_unit",
        type: "decimal",
    ...
    __metadata("design:type", Number)
], Product.prototype, "price_unit", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: "sale_type", type: "varchar", length: 20 }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => branch_entity_1.Branch, (branch) => branch.products),
